...
#>
  Param(
    ...
    ForEach ($username in $usernames){
        ...
        $BodyParams = @{'resource' = 'https://graph.chinacloudapi.cn'; 'client_id' = '1b730954-1685-4b74-9bfd-dac224a7b894' ; 'client_info' = '1' ; 'grant_type' = 'password' ; 'username' = $username ; 'password' = $password ; 'scope' = 'openid'}
